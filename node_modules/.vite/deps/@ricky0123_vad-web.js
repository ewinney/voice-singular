...
var require_legacy = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/models/legacy.js"(exports2) {
    ...
    var SileroLegacy = class {
      constructor(ortInstance, _session, _h2, _c2, _sr) {
    ...
    SileroLegacy.new = async (ortInstance, modelFetcher) => {
      ...
      const zeroes = Array(2 * 64).fill(0);
      const _h2 = new ortInstance.Tensor("float32", zeroes, [2, 1, 64]);
      const _c2 = new ortInstance.Tensor("float32", zeroes, [2, 1, 64]);
      logging_1.log.debug("vad is initialized");
      const model = new _a(ortInstance, _session, _h2, _c2, _sr);
      return model;
    };
  }
});
...
var require_non_real_time_vad = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/non-real-time-vad.js"(exports2) {
    ...
    var PlatformAgnosticNonRealTimeVAD = class {
      static async _new(modelFetcher, ort2, options = {}) {
        const fullOptions = {
          ...exports2.defaultNonRealTimeVADOptions,
          ...options
        };
        if (fullOptions.ortConfig !== void 0) {
          fullOptions.ortConfig(ort2);
        }
        const vad = new this(modelFetcher, ort2, fullOptions);
        await vad.init();
        return vad;
      }
      constructor(modelFetcher, ort2, options) {
...
var require_utils = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/utils.js"(exports2) {
    ...
    function minFramesForTargetMS(targetDuration, frameSamples, sr2 = 16e3) {
      return Math.ceil(targetDuration * sr2 / 1e3 / frameSamples);
    }
    ...
    async function audioFileToArray(audioFileData) {
      ...
      for (let i = 0; i < _audioBuffer.length; i++) {
        for (let j2 = 0; j2 < _audioBuffer.numberOfChannels; j2++) {
          out[i] += _audioBuffer.getChannelData(j2)[i];
        }
      }
...
var require_dist = __commonJS({
  "node_modules/@ricky0123/vad-web/dist/index.js"(exports2) {
    ...
    var ort2 = __importStar(require_ort_min());
    ...
    var NonRealTimeVAD = class extends non_real_time_vad_1.PlatformAgnosticNonRealTimeVAD {
      static async new(options = {}) {
